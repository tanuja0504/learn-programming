...
public class MinHeightTrees {
    public static List<Integer> findMinHeightTrees(int n, int[][] edges) {
        ...
        List<Integer> adjV[] = new ArrayList[n];
        ...
        for (int i = 0; i < edges.length; i++) {
            adjV[edges[i][0]].add(edges[i][1]);
            adjV[edges[i][1]].add(edges[i][0]);
            innode[edges[i][0]]++;
            innode[edges[i][1]]++;
        }
        ...
        for (int i = 0; i < n; i++) {
            if (innode[i] == 1 && !visited.contains(i)) {
                q.add(i);
                visited.add(i);
            }
        }
        ...
        while (!q.isEmpty()) {
            ...
            result.put(level, new ArrayList<>(r));
            r.clear();
        }
